...
namespace Valhaus.Data.Migrations
{
    ...
    [Migration("20251215115118_Add Order Header and Order Details table")]
    partial class AddOrderHeaderandOrderDetailstable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Valhaus.Models.Models.Company", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Valhaus.Models.Models.OrderDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Valhaus.Models.Models.OrderHeader", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Valhaus.Models.Models.ShoppingCart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Valhaus.Models.Models.OrderDetail", b =>
                {
                    b.HasOne("Valhaus.Models.Models.OrderHeader", "OrderHeader")
                        .WithMany()
                        .HasForeignKey("OrderHeaderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Valhaus.Models.Models.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("Valhaus.Models.Models.OrderHeader", b =>
                {
                    b.HasOne("Valhaus.Models.Models.ApplicationUser", "ApplicationUser")
                        .WithMany()
